...
MAPJS.exportIdeas = function (contentAggregate, exporter) {
	'use strict';
...
MAPJS.TabSeparatedTextExporter = function () {
	'use strict';
	var contents = [];
...
MAPJS.HtmlTableExporter = function () {
	'use strict';
	var result;
	this.begin = function () {
...
MAPJS.exportToHtmlDocument = function (idea) {
	'use strict';
...
MAPJS.exportTableToText = function (table) {
	'use strict';
